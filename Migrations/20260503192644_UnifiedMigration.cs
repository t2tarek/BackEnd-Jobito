        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CrDocumentUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    Classification = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    FoundedDay = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    FoundedMonth = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    FoundedYear = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ...
                    LocationTags = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LogoUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OfficePhoto1Url = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OfficePhoto2Url = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OfficialNationalId = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JobsViewed = table.Column<int>(type: "int", nullable: false),
                    ViewsDirect = table.Column<int>(type: "int", nullable: false),
                    ViewsSocial = table.Column<int>(type: "int", nullable: false),
                    ViewsOrganic = table.Column<int>(type: "int", nullable: false),
                    ViewsOther = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SalaryMin = table.Column<decimal>(type: "decimal(10,2)", precision: 18, scale: 2, nullable: true),
                    SalaryMax = table.Column<decimal>(type: "decimal(10,2)", precision: 18, scale: 2, nullable: true),
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Latitude = table.Column<decimal>(type: "decimal(10,7)", nullable: true),
                    Longitude = table.Column<decimal>(type: "decimal(10,7)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobUpdates_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsHelpfulYes = table.Column<int>(type: "int", nullable: false),
                    IsHelpfulNo = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JobsManyId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobCategories", x => new { x.CategoriesId, x.JobsManyId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobCategories_Jobs_JobsManyId",
                        column: x => x.JobsManyId,
                        principalTable: "Jobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobCategories_JobsManyId",
                table: "JobCategories",
                column: "JobsManyId");
